  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,province,description,content,article_status,view_count,like_count,comment_status,comment_count,last_comment_user_id,picurls,publish_date,last_modify_date").get().then((res) => {
